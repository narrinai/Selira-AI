#!/bin/bash
# Rollout script for avatar_url_2 generation for all censored companions
# Runs the bulk script repeatedly until all companions have avatar_url_2

FUNCTION_URL="https://selira.ai/.netlify/functions/generate-avatar-2-censored-bulk?trigger=manual"
...
echo "🚀 Starting Censored Avatar_url_2 Rollout"
echo "=================================================="
echo ""
echo "Target: All Selira censored companions without avatar_url_2"
echo "Expected: ~344 companions to process"
