#!/bin/bash
# Rollout script for avatar_url_2 generation for all uncensored female companions
# Runs the bulk script repeatedly until all companions have avatar_url_2

FUNCTION_URL="https://selira.ai/.netlify/functions/generate-avatar-2-bulk?trigger=manual"
...
echo "🚀 Starting Uncensored Female Avatar_url_2 Rollout"
echo "=================================================="
echo ""
echo "Target: All Selira uncensored female companions without avatar_url_2"
