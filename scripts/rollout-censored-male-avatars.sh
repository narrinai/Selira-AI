#!/bin/bash
# Rollout script for avatar_url_2 generation for all censored MALE companions
# Runs the bulk script repeatedly until all companions have avatar_url_2

FUNCTION_URL="https://selira.ai/.netlify/functions/generate-avatar-2-censored-male-bulk?trigger=manual"
MAX_ITERATIONS=200  # Safety limit
DELAY_BETWEEN_CALLS=35  # 35 seconds between calls (function takes ~20s + buffer)

echo "🚀 Starting Censored Male Avatar_url_2 Rollout"
echo "=================================================="
echo ""
echo "Target: All Selira censored MALE companions without avatar_url_2"
echo "Expected: ~172 companions to process"
