...
/**
 * Generate New Uncensored Companions with Varied Avatars
 *
 * Creates new uncensored companions with:
...
const COMPANIONS_TO_CREATE = parseInt(process.argv[2]) || 5; // Default 5 companions
...
// Name pools
const FEMALE_NAMES = ['Scarlett', 'Luna', 'Aria', 'Jade', 'Phoenix', 'Raven', 'Violet', 'Ivy', 'Ruby', 'Aurora', 'Sienna', 'Nova', 'Willow', 'Hazel', 'Eden'];
const MALE_NAMES = ['Dante', 'Phoenix', 'Axel', 'Kai', 'Xavier', 'Blake', 'Hunter', 'Jax', 'Ryder', 'Cole', 'Zane', 'Ace', 'Cruz', 'Asher', 'Nico'];
const LAST_NAMES = ['Steele', 'Fox', 'Wolfe', 'Stone', 'Knight', 'Hunter', 'Black', 'Grey', 'Storm', 'Wilde', 'Savage', 'Frost', 'Blaze', 'Shadow', 'Rogue'];
