...
async function generateMaleAvatar(companionData) {
  ...
  try {
    ...
    if (companionData.artStyle === 'anime') {
      attractivePrompt = `handsome anime guy, attractive masculine face, seductive bedroom eyes, ${clothingStyle}, toned muscular body, ${backgroundScene}, BRIGHT ILLUMINATION, VIVID LIGHTING, HIGH CONTRAST, detailed anime art style, vibrant colors, high quality anime illustration, confident seductive pose, masculine charm, single male character, solo portrait, KEY LIGHT on subject, FILL LIGHT brightening character, RIM LIGHT separating subject from background, STUDIO LIGHTING setup, character is BRIGHTLY LIT, background is DARKER than subject, DRAMATIC CONTRAST between character and background, subject POPS OUT visually, WELL-EXPOSED character, NO dark shadows on face, BRIGHT and CLEAR visibility`;
    } else {
      attractivePrompt = `handsome muscular man, attractive masculine face, seductive intense gaze, ${clothingStyle}, athletic build with defined muscles, ${backgroundScene}, BRIGHT ILLUMINATION, VIVID LIGHTING, HIGH CONTRAST, photorealistic photography, professional portrait, masculine energy and charm, confident seductive pose, high quality photo, single male person, solo, KEY LIGHT on subject, FILL LIGHT brightening subject, BACK LIGHT rim lighting, RIM LIGHT separating subject from background, PROFESSIONAL STUDIO LIGHTING, subject is BRIGHTLY LIT, background is DARKER and BLURRED, DRAMATIC CONTRAST between subject and background, subject POPS OUT from background, shallow depth of field, bokeh background, WELL-EXPOSED subject, NO dark shadows on face, GOLDEN HOUR LIGHTING quality, BRIGHT and CLEAR subject, subject is LUMINOUS and RADIANT`;
    }
