...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('📊 Fetching PUBLIC UNCENSORED FEMALE companions without Avatar_URL_2...');

    let allCompanions = [];
    let offset = null;

    do {
      // Filter: No Avatar_URL_2 AND content_filter = 'Uncensored' AND sex = 'female' AND Public = 1 (only public companions)
      const filterFormula = encodeURIComponent("AND(NOT({Avatar_URL_2}), {content_filter} = 'Uncensored', {sex} = 'female', {Public} = 1)");
