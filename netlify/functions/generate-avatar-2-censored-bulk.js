// netlify/functions/generate-avatar-2-censored-bulk.js
// Scheduled function to generate avatar_url_2 for CENSORED companions that don't have one yet
  ...
  try {
    ...
    const response = await fetch('https://selira.ai/.netlify/functions/selira-generate-custom-image', {
      ...
      body: JSON.stringify({
        ...
        source: 'avatar-2-censored-bulk-generation',
