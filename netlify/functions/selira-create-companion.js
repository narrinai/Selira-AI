...
- Maintain the character traits indicated by your tags`;
    ...
    if (!preGeneratedAvatarUrl) {
      ...
      if (artStyle === 'anime') {
        attractivePrompt = `beautiful anime girl, attractive face, confident expression, detailed anime art, elegant pose, wearing ${clothingStyle}, anime style, vibrant colors, high quality anime artwork, detailed facial features, anime eyes, perfect anime anatomy, graceful pose, single character, solo, professional anime illustration`;
      } else {
        attractivePrompt = `beautiful woman, attractive face, confident expression, elegant pose, wearing ${clothingStyle}, photorealistic, professional photography, soft lighting, portrait photography style, eye contact, sharp focus, attractive model, graceful pose, single person, solo, professional headshot`;
      }
