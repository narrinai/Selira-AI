...
async function getCharacterData(character_slug, airtableBaseId, airtableToken) {
  const url = `https://api.airtable.com/v0/${airtableBaseId}/Characters?filterByFormula={Slug}='${character_slug}'&maxRecords=1`;
